...
console.log(ending_match("Life is what happens when you're busy making other plans", "plans"));
...
console.log(ending_match_custom("Life is what happens when you're busy making other plans", "plans"));
...
console.log(ending_match_custom_without_inbuilt("Life is what happens when you're busy making other plans", "plan"));
