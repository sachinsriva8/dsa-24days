...
let anagram1=(str1,str2)=>{
    ...
    if(str1.length===0 && str2.length===0){  //if both string is empty then also its anagram. 
        return true;
    }
 ...
 * @step2 using JS argument. Basically argument is an array containing num1,num2.
 * @step3 using array destructuring to swap variables without using any extra variable.
 * @step4 return num1, num2.
 */

// let swap_without3rd_var=(num1, num2)=>{
//     [num2,num1]=arguments[0,1];
//     return `${num1}  ${num2}`;
// }

// console.log(swap_without3rd_var(6,7));
